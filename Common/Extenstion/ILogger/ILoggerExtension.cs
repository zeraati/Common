...
{
    public static void LogDebugCustom(this ILogger logger, string? traceId, object obj, bool jsonIndented = true, string? descriptor = null
    ...
    public static void LogErrorCustom(this ILogger logger, string? traceId, object obj, bool jsonIndented = true, string? descriptor = null,
        [CallerArgumentExpression(nameof(obj))] string param = "", [CallerMemberName] string callMember = "")
    {
